...
iteration2 = Blueprint('iteration2', __name__, 
...
@iteration2.route('/', methods=['GET', 'POST'])
def index():
    if 'authenticated' in session and session['authenticated']:
        ...
        return render_template('iteration2_index.html', total_loss=total_loss, number_of_reports=number_of_reports, affected_people_65plus=affected_people_65plus)
...
#home
@iteration2.route('/home')
def home():
    return render_template('iteration2_index.html')

#scam
@iteration2.route('/scam')
def scam():
    return render_template('iteration2_scam.html')

#safemethods
@iteration2.route('/safemethods')
def safemethods():
    return render_template('iteration2_accountsafety.html')

#statistics
@iteration2.route('/statistics')
def statistics():
    return render_template('iteration2_statistics.html')

#report
@iteration2.route('/resources')
def resources():
    return render_template('iteration2_resources.html')
...
@iteration2.route('/detect_scam', methods=['GET', 'POST'])
def detect_scam():
    ...
    return render_template('iteration2_detect_scam.html', prediction=prediction, original_message=original_message)




    
@iteration2.route('/test-mysql-connection')
